...
اگر اشکالی در ترجمه‌ی یکی از صفحه‌ها پیدا کرده‌اید، لطفاً یک ایشیو با قالب «اشکال در ترجمه» ایجاد کنید.

در ایشیو، لطفاً موارد زیر را ذکر کنید:
...
2. پس از بررسی و تأیید اولیه‌ی نگهدارندگان پروژه، یک نظرسنجی هم‌زمان در گروه تلگرام و در همان ایشیوی گیت‌هاب (با گزینه‌های پسندیدن/نپسندیدن) آغاز می‌شود.
...
5. اگر پیشنهاد تغییر رأی موافق کسب کند، به یک ایشیوی اصلی (master issue) که فهرست کارها و تغییرات قابل‌انجام را پیگیری می‌کند اضافه خواهد شد تا هر مشارکت‌کننده‌ای که مایل باشد بتواند اجرای آن را بر عهده بگیرد.

## افزودن واژه یا اصطلاح جدید به واژه‌نامه

اگر واژه یا اصطلاحی در واژه‌نامه‌ی پروژه وجود ندارد و می‌خواهید معادل پیشنهادی برای آن اضافه شود، یک ایشیو با قالب **«پیشنهاد تغییرات در ترجمه»** باز کنید و واژه‌ی انگلیسی، معادل پیشنهادی، و دلیل انتخاب آن را توضیح دهید.
